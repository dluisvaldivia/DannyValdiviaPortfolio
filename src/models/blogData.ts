...
<p>Accessibility isn't a feature. It's a quality bar. Build to it from the start and it costs almost nothing. Retrofit it later and it costs a lot.</p>
  ...
  },
  {
    ...
    excerpt:
      'AI tools have changed how I work. Not by replacing judgement, but by removing the grunt work that used to slow it down.',
    content: `
...
<p>I also never ship AI-generated code without reading it. Not because I distrust it, but because <em>I</em> am responsible for it. If there's a bug or a security hole, "the AI wrote it" is not a defence.</p>
